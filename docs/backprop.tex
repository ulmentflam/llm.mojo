...
\begin{result}
  ...
  \begin{align}
    \dL{x_i}
     ...
     & = \sum_j \dL{y_j} \left[ \frac{\gamma_j}{\sqrt{\sigma^2}} \left( \kron{j}{i} - \frac{1}{C} - \frac{(x_i - \mu)(x_j - \mu)}{C\sigma^2} \right) \right] \notag \\
     & = \frac{1}{\sqrt{\sigma^2}} \left( \sum_j \gamma_j \dL{y_j} \ind{j=i} - \frac{1}{C} \sum_j \gamma_j \dL{y_j} - \frac{x_i - \mu}{C\sqrt{\sigma^2}} \sum_j \gamma_j \dL{y_j} \frac{x_j - \mu}{\sqrt{\sigma^2}} \right) \notag \\
     & = \frac{1}{\sqrt{\sigma^2}} \left( \gamma_i \dL{y_i} - \frac{1}{C} \sum_j \gamma_j \dL{y_j} - \frac{x_i - \mu}{C\sqrt{\sigma^2}} \sum_j \gamma_j \dL{y_j} \frac{x_j - \mu}{\sqrt{\sigma^2}} \right).
    \label{eq:ln-bwd}
  \end{align}
