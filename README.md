...
|---|---|---:|---|---:|---|
| GPT-2 124M | bf16 | _training_ | _training_ | _—_ | _pending_ |
| GPT-2 124M | fp8 | _training_ | _training_ | _—_ | _pending_ |
| GPT-2 124M | nvfp4 | _training_ | _training_ | _—_ | _pending_ |
| GPT-2 774M | bf16 | _training_ | _training_ | _—_ | _pending_ |
| GPT-2 774M | fp8 | _training_ | _training_ | _—_ | _pending_ |
| GPT-2 774M | nvfp4 | _training_ | _training_ | _—_ | _pending_ |

> **0 of 6 arms complete.** Still training: 124M-bf16, 124M-fp8, 124M-nvfp4, 774M-bf16, 774M-fp8, 774M-nvfp4. Rows fill in as each arm finishes, is scored, and is published.
